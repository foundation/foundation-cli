...
module.exports.new = function(args, options) {
  ...
  exec(gitClone, function(err, out, code) {
    if (err instanceof Error) {
      console.log(err);
      console.log("There was an issue running " + "git clone ".cyan + "to download the Foundation for Apps template. Make sure your machine's Git is configured properly and then try again.")
      process.exit(0);
    }
