...
module.exports = function(projectName, messageFramework, messageTemplate) {
  return {
    helloYeti: [
      ...
      '-------------------------------------------',
      'Let\'s set up a new project using ' + 'TBG\'s fork'.yellow + '.',
    ...
    installSuccessFinal: "\nNow run " + "tbg-foundation watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "tbg-foundation watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
