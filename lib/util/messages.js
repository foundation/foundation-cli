<<<<<<< HEAD
module.exports = function(projectName,frameworkName,messageTemplate) {
=======
var colors = require('colors');

module.exports = function(projectName,messageFramework,messageTemplate) {
>>>>>>> parent of 497c5f0... removed unnecessary require from messages.js
  return {
    helloYeti: [
      ...
      downloadingTemplate: "\nDownloading the "+ messageTemplate.cyan + " template for your " + projectName.cyan + " project...\n\n",

      gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the framework " + "Foundation for ".cyan + frameworkName.cyan + " and template " + messageTemplate.cyan +".\nMake sure your computer's Git is configured properly and then try again.",
