exports.usage = "$0 -operand1 number -operand2 number -operation [add|subtract]";
  //'new [--directory|--project <name>] [--framework] [--template <basic|zurb>] ';
exports.desc = 'Create a new Foundation project';

//exports.example = '$0 new -d -f -t';
